...
export const LoginForm = ({ updateTokenAndLogin, toggleLoginModal }: any) => {
  ...
  return (
    <div className='loginModal' style={{ width: window.outerWidth, height: window.outerHeight}} >
      <div className='loginBackground' style={{ width: window.outerWidth, height: window.outerHeight}} onClick={toggleLoginModal}></div>
      <div className='loginFormWrap'>
        <Form onSubmit={handleLogin} title='Log in'>
          ...
          <Input type='password' name='password' placeholder='Password' onChange={handleInput} value={credentials.password}/>
